...
export class StatusBar{
    ...
    updateTime(time){
        ...
        if(this.time < 16  && this.time > -1 && time.previous > this.timeFlashTimer + TIME_FLASH_DELAY){
    ...
    updateKoIcon(time){
        if(this.healthBars.every((healthBars) => healthBars.hitPoints > HEALTH_CRITICAL_HIT_POINTS))
            return;
