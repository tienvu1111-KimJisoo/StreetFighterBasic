...
export class Ken extends Fighter{
    constructor(playerId, onAttackHit){
        ...
        this.frames = new Map([
            ...
            ['jump-up-4', [[[911, 966, 48, 78], [28, 101]], PushBox.JUMP, HurtBox.JUMP]],
            ...
            // Medium Punch
            ['medium-punch-1', [[[517, 1149, 60, 94], [28, 91]], PushBox.IDLE, HurtBox.IDLE]],
            ['medium-punch-2', [[[650, 1148, 74, 95], [29, 92]], PushBox.IDLE, HurtBox.PUNCH]],
            ['medium-punch-3', [[[736, 1148, 108, 94], [24, 92]], PushBox.IDLE, HurtBox.PUNCH, [17, -85, 68, 14]]],
            ...
            ['light-kick-2', [[[143, 1565, 114, 92], [68, 95]], PushBox.IDLE, [[-65, -96, 30, 18], [-57, -79, 42, 38], [-32, 52, 44, 50]], [-17, -98, 66, 28]]],

            // Medium Kick
            ['medium-kick-1', [[[143, 1565, 114, 94], [68, 93]], PushBox.IDLE, [[-65, -96, 30, 18], [-57, -79, 42, 38], [-32, 52, 44, 50]], [-18, -98, 80, 28]]],
            ...
            ['hit-face-2', [[[400, 3279, 68, 89], [47, 85]], PushBox.IDLE, [[-42, -88, 20, 20], [-46, -74, 40, 46], [-33, -37, 40, 38]]]],
            ...
            ['hit-stomach-3', [[[149, 3287, 71, 78], [40, 81]], PushBox.IDLE, [[-17, 82, 28, 18], [-41, -59, 38, 30], [-34, -34, 42, 34]]]],
            ...
            ['stun-3', [[[1, 3367, 67, 90], [33, 88]], PushBox.IDLE, [[-22, -91, 28, 18], [-30, -72, 42, 40], [-26, -31, 40, 32]]]],
        ]);
        ...
        this.animations = {
            ...
            [FighterState.JUMP_FORWARD]: [
                ['jump-roll-1', 232], ['jump-roll-2', 50], ['jump-roll-3', 50],
            ...
            [FighterState.IDLE_TURN]:[
                ...
                ['idle-turn-3', 33], ['idle-turn-1', FrameDelay.TRANSITION],
            ],
            ...
            [FighterState.HEAVY_PUNCH]:[
                ['medium-punch-1', 50], ['medium-punch-2', 33], ['medium-punch-3', 100],
            ...
            [FighterState.HEAVY_KICK]:[
                ...
                ['heavy-kick-2', 166], ['heavy-kick-5', 116], 
